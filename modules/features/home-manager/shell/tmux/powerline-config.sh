# Adapted default configuration file for tmux-powerline.
# Modeline {
...
# The theme to use.
export TMUX_POWERLINE_THEME="powerline-stylix-theme"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/patrick/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/patrick/.mailcheckrc"
# }
